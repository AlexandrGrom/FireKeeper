...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty douleTapTolerance;
    ...
    protected virtual void OnEnable()
    {
        ...
        douleTapTolerance = serializedObject.FindProperty("dableTapTolerance");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(douleTapTolerance, new GUIContent("Tolerance","Tolerance of doule tap"));
    }
